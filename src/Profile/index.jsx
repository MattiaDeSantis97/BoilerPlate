  ...
  const handleSendChat = (e) => {
    ...
    setTimeout(() => {
      setChatMessages((prev) => [
        ...
        {
          sender: 'Assistenza',
          text: 'Un operatore ti risponderà a breve. Attendi in linea.',
        },
      ]);
    }, 1000);
  };
          ...
          <Card.Body className="p-4">
            ...
            <Form onSubmit={handleAuthSubmit}>
              ...
              <Button
                variant="light"
                type="submit"
                className="w-100 fw-bold fs-5 mb-3"
              >
          ...
          <Card.Body className="p-4 text-white">
              ...
              <Row className="g-4">
                <Col md={6}>
                  <div className="p-3 border border-light rounded bg-dark bg-opacity-25 h-100">
                    <h5 className="border-bottom border-light pb-2 mb-3 fw-bold">
                      Dati Attuali
                    </h5>
                    <p className="mb-2">
                ...
                <Col md={6}>
                  <div className="d-flex flex-column gap-3 h-100">
                    ...
                    <Button
                      variant="outline-light"
                      size="lg"
                      className="text-start fw-semibold d-flex justify-content-between align-items-center"
                ...
                <Form onSubmit={handleUpdateProfile}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      value={user.email}
                      disabled
                      className="glass-input bg-dark bg-opacity-50 text-white-50"
                    />
                  </Form.Group>
                  <Form.Group className="mb-3">
            ...
            {activeTab === 'orders' && (
              <div className="text-center py-5">
                <h3 className="fw-bold opacity-50 mb-3">
                  Nessun ordine all'attivo
                </h3>
                <p className="opacity-75">
                  Non hai ancora effettuato acquisti. Inizia a esplorare il
                  nostro catalogo.
                </p>
              </div>
            )}
            ...
            {activeTab === 'notifications' && (
              <div className="d-flex flex-column gap-3">
                <Alert
                  variant="info"
                  className="mb-0 bg-dark bg-opacity-50 text-white border-info"
                >
                  <strong>Benvenuto:</strong> Grazie per esserti registrato.
                  Esplora le funzionalità del tuo nuovo account.
                </Alert>
                <Alert
                  variant="warning"
                  className="mb-0 bg-dark bg-opacity-50 text-white border-warning"
                >
                  <strong>Privacy:</strong> Abbiamo aggiornato i nostri termini
                  di servizio in data odierna.
                </Alert>
                <Alert
                  variant="success"
                  className="mb-0 bg-dark bg-opacity-50 text-white border-success"
                >
                  <strong>Promozione:</strong> Hai diritto al 10% di sconto sul
                  tuo primo ordine. Usa il codice WELCOME10.
                </Alert>
              </div>
            )}
              ...
              <div className="d-flex flex-column" style={{ height: '400px' }}>
                <div className="flex-grow-1 overflow-auto p-3 mb-3 border border-light rounded bg-dark bg-opacity-25 d-flex flex-column gap-2">
                  {chatMessages.map((msg, idx) => (
                    <div
                      key={idx}
                      className={`p-2 rounded ${msg.sender === 'Tu' ? 'bg-primary align-self-end text-white' : 'bg-secondary align-self-start text-white'}`}
                      style={{ maxWidth: '75%' }}
                    >
                      <strong className="d-block small opacity-75">
                        {msg.sender}
                      </strong>
                      {msg.text}
                    </div>
